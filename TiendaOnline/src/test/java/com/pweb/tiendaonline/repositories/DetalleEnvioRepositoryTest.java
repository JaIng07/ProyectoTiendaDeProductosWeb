...
class DetalleEnvioRepositoryTest extends AbstractIntegrationDBTest {
   ...
   /* @Test
    public void DetalleEnvioRepositoryTest_UpdateShippingDetail_ReturnDetailNotNull(){
        ...
        savedShippingDetail.setDireccion("Barrio: Portal universitaro, Calle2U#13");

        DetalleEnvio updatedShippingDetail = detalleEnvioRepository.save(savedShippingDetail);
        ...
        Assertions.assertThat(updatedShippingDetail.getDireccion()).isEqualTo("Barrio: Portal universitaro, Calle2U#13");
    }*/
